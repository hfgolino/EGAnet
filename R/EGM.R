...
#' \itemize{
#'
#' \item \code{"beta.min"} --- Applies the \code{\link[EGAnet]{modularity}}-adjusted (\code{Q})
#' beta-min criterion to threshold the implied partial correlation matrix
#' \deqn{Q \times \sqrt{\frac{\log{(p)}}{n}}}
#'
