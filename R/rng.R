#' @title Random Number Generation in \code{\link{EGAnet}}
#' 
#' @aliases rng RNG
#'
#' @description Random number generation is important and some methods
...
#' 
#' @details \strong{EGAnet Random Number Generation}
#' 
...
#' @export
#' 
# Function to print source information for RNG ----
# Updated 27.07.2023
rng <- function()
{
  ...
  cat("Algortihm: xoshiro128++\n")
  cat("\nSource: https://prng.di.unimi.it/xoshiro128plusplus.c \n")
  cat("\nCitation: \n\n")
  cat(
    paste0("Blackman, D., & Vigna, S. (2022). Scrambled linear pseudorandom number generators."),
    paste0(styletext("arXiv", defaults = "italics"), "."),
    paste0("https://arxiv.org/abs/1805.01407")
  )
  ...
  cat("Algorithm: Ziggurat\n")
  cat("\nSource: https://people.sc.fsu.edu/~jburkardt/c_src/ziggurat/ziggurat.c \n")
  cat("\nCitation: \n\n")
  cat(
    paste0("Marsaglia, G., & Tsang, W. W. (2000). The Ziggurat method for generating random variables."),
    paste0(styletext("Journal of Statistical Software", defaults = "italics"), ","),
    paste0(styletext("5", defaults = "italics"), "(8), 1-7."),
    paste0("https://doi.org/10.18637/jss.v005.i08")
  )
