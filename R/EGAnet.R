...
#' Triangulated Maximally Filtered Graph (\code{\link[EGAnet]{TMFG}}) and a weighted network community detection algorithm (Christensen, Garrido, Golino, under review A). A bootstrap method for
