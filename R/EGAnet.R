...
#' @importFrom stats as.dendrogram as.dist as.hclust complete.cases cor cov cov2cor cutree dist dnorm hclust ks.test mad median na.omit nlm nlminb optim p.adjust pchisq pgamma pnorm qchisq qf qgamma qnorm qt quantile rnorm runif sd setNames t.test uniroot var wilcox.test
