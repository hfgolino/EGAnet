#' Clustering for \code{\link[EGAnet]{dynEGA}}
#'
...
# Updated 06.07.2022
dynEGA.cluster <- function(dynEGA.object, ncores, plot.cluster = TRUE)
{
  ...
  # Obtain clusters
  cluster_list[[1]] <- consensus_clustering(
    jss, corr = jss,
    order = "lower",
    consensus.iter = 1000
  )$most_common
