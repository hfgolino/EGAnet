...
# Introduction
This vignette shows you how to use the node.redundant functions in EGAnet. The contents of this vignette is taken from the supplementary information of Christensen, Golino, and Silvia (2020).

To begin our example of structural validation from the psychometric network perspective, the *psychTools* (Revelle, 2019) pacakge must be installed and loaded.
...
Dinic, B. M., Wertag, A., Tomaševic, A., & Sokolovska, V. (in press). Centrality and redundancy of the Dark Tetrad traits. *Personality and Individual Differences*, *155*, 109621. https://doi.org/10.1016/j.paid.2019.109621
