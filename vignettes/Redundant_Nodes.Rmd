...
To begin our example of structural validation from the psychometric network perspecitve, the *psych* (Revelle, 2017) pacakge must be installed and loaded.

```{r install, echo = TRUE, eval = FALSE, message = FALSE, warning = FALSE}
# Install 'psych' package
devtools::install_version("psych", version = 1.8.12)
```
