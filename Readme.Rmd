---
title: "Exploratory Graph Analysis: An introduction using the EGA package."
...
## What is _Exploratory Graph Analysis_
...
# Installing EGA package

To install `EGA` from Github, you need to use the `devtools` package (Whickham, )
...
- `bootEGA`: Estimates the number of dimensions of *n* **bootstraps** from the empirical correlation matrix, and returns a typical network (i.e. the network formed by the median pairwise correlations over the *n* **bootstraps**) and its dimensionality. 
